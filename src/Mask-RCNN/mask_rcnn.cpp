...
int main(int argc, char **argv)
{
    ...
    // resize the window
    resizeWindow(kWinName, width, height);
    ...
    while (waitKey(1) < 0)
    {
        Mat orig_frame, frame, dst_frame, blob;
        ...
        Matx33d newK = theK;
        // resize(orig_frame, dst_frame, Size(), scale, scale);
        // fisheye::undistortImage(dst_frame, frame, theK, theD, newK);
        frame = orig_frame;
