...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        camViewer->setGeometry(QRect(20, 10, 600, 360));
        camViewer->setFocusPolicy(Qt::NoFocus);
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(300, 380, 90, 32));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Qt Application Using OpenCV", nullptr));
